...
export default function Welcome({ activeEvents, featuredTemplates, stats, auth }: Props) {
                    ...
                    <div className="max-w-7xl mx-auto text-center">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
                            ...
                            <div className="bg-white/60 backdrop-blur-sm rounded-xl p-6 border border-blue-200">
                                ...
                                <div className="text-3xl font-bold text-blue-900 mb-1">{stats?.totalTemplates || 0}</div>
                            ...
                            <div className="bg-white/60 backdrop-blur-sm rounded-xl p-6 border border-blue-200">
                                ...
                                <div className="text-3xl font-bold text-blue-900 mb-1">{stats?.activeGreetings || 0}</div>
                ...
                <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white/30 backdrop-blur-sm">
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {featuredTemplates && featuredTemplates.slice(0, 8).map((template) => (
